...
{ // Dungeon (OOD cap: 27)
  ...
  {  3,  7, 1000, FLAT, MONS_ORC },
  {  3,  9,  335, SEMI, MONS_HOWLER_MONKEY },
...
{ // Vaults (OOD cap: 12)
  ...
  {  1,  2,  440, FALL, MONS_SLIME_CREATURE },
  {  1,  2,  440, FALL, MONS_UGLY_THING },
  {  1,  3,  136, FLAT, MONS_RAKSHASA },
  {  1,  3,  222, FLAT, MONS_WIZARD },
  {  1,  3,  440, FALL, MONS_CENTAUR_WARRIOR },
  {  1,  4,   32, PEAK, MONS_CRYSTAL_GUARDIAN },
  ...
  {  1,  9,  640, FALL, MONS_VAULT_SENTINEL },
  {  1,  9,  640, FALL, MONS_IRONBRAND_CONVOKER },
