...
enum ability_type
{
    ...
    // Hepliaklqanal
    ABIL_HEPLIAKLQANAL_RECALL = 1240,
    ABIL_HEPLIAKLQANAL_REMEMBER,
    ABIL_HEPLIAKLQANAL_PRESERVE,
    ABIL_HEPLIAKLQANAL_SWAP,

    ABIL_HEPLIAKLQANAL_DEATH_SLOW,
        ABIL_HEPLIAKLQANAL_FIRST_DEATH = ABIL_HEPLIAKLQANAL_DEATH_SLOW,
    ABIL_HEPLIAKLQANAL_DEATH_FOG,
    ABIL_HEPLIAKLQANAL_DEATH_EXPLODE,
    ABIL_HEPLIAKLQANAL_DEATH_DISPERSE,
    ABIL_HEPLIAKLQANAL_DEATH_IMPLODE,
        ABIL_HEPLIAKLQANAL_LAST_DEATH = ABIL_HEPLIAKLQANAL_DEATH_IMPLODE,

    ABIL_HEPLIAKLQANAL_TYPE_FIGHTER,
        ABIL_HEPLIAKLQANAL_FIRST_TYPE = ABIL_HEPLIAKLQANAL_TYPE_FIGHTER,
    ABIL_HEPLIAKLQANAL_TYPE_WIZARD,
    ABIL_HEPLIAKLQANAL_TYPE_ENCHANTER,
        ABIL_HEPLIAKLQANAL_LAST_TYPE = ABIL_HEPLIAKLQANAL_TYPE_ENCHANTER,
...
enum monster_type                      // menv[].type
{
    ...
    MONS_ANCESTOR,              // Hepliaklqanal
    MONS_ANCESTOR_FIGHTER,
    MONS_ANCESTOR_WIZARD,
    MONS_ANCESTOR_ENCHANTER,
#endif
    MONS_TEST_SPAWNER,
