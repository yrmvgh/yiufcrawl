...
enum ability_type
{
    ...
    ABIL_HELPAL_DEATH_SLOW,
        ABIL_HELPAL_FIRST_DEATH = ABIL_HELPAL_DEATH_SLOW,
    ABIL_HELPAL_DEATH_FOG,
    ABIL_HELPAL_DEATH_EXPLODE,
    ABIL_HELPAL_DEATH_DISPERSE,
    ABIL_HELPAL_DEATH_IMPLODE,
        ABIL_HELPAL_LAST_DEATH = ABIL_HELPAL_DEATH_IMPLODE,

    ABIL_HELPAL_TYPE_DEFENDER,
        ABIL_HELPAL_FIRST_TYPE = ABIL_HELPAL_TYPE_DEFENDER,
    ABIL_HELPAL_TYPE_ATTACKER,
    ABIL_HELPAL_TYPE_SUPPORTER,
        ABIL_HELPAL_LAST_TYPE = ABIL_HELPAL_TYPE_SUPPORTER,
