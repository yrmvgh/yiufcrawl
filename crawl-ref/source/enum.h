...
enum ability_type
{
    ...
    ABIL_HEPLIAKLQANAL_DRAW_FROM_MEMORY,
    ABIL_HEPLIAKLQANAL_ROMANTICIZE,
    ABIL_HEPLIAKLQANAL_TRANSFERENCE,
    ...
    ABIL_HEPLIAKLQANAL_TYPE_KNIGHT,
        ABIL_HEPLIAKLQANAL_FIRST_TYPE = ABIL_HEPLIAKLQANAL_TYPE_KNIGHT,
    ABIL_HEPLIAKLQANAL_TYPE_BATTLEMAGE,
    ABIL_HEPLIAKLQANAL_TYPE_HEXER,
        ABIL_HEPLIAKLQANAL_LAST_TYPE = ABIL_HEPLIAKLQANAL_TYPE_HEXER,
