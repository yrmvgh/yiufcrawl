...
enum monster_type                      // menv[].type
{
    ...
    MONS_LAST_SPAWNED_BASE_DRACONIAN = MONS_WHITE_DRACONIAN,
    MONS_GREY_DRACONIAN,
    MONS_PALE_DRACONIAN,
    ...
    MONS_LAST_SPAWNED_DRACONIAN = MONS_DRACONIAN_ANNIHILATOR,
    MONS_LAST_SPAWNED_NONBASE_DRACONIAN = MONS_DRACONIAN_ANNIHILATOR,
#if TAG_MAJOR_VERSION == 34
...
#else
    MONS_LAST_DRACONIAN = MONS_DRACONIAN_ANNIHILATOR,
    MONS_LAST_NONBASE_DRACONIAN = MONS_DRACONIAN_ANNIHILATOR,
#endif
