...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_TROLL,           SK_CONJURATIONS,    0),
    APT(SP_TROLL,           SK_HEXES,           0),
    APT(SP_TROLL,           SK_CHARMS,          0),
    APT(SP_TROLL,           SK_SUMMONINGS,      0),
    APT(SP_TROLL,           SK_NECROMANCY,      0),
    APT(SP_TROLL,           SK_TRANSLOCATIONS,  0),
    APT(SP_TROLL,           SK_TRANSMUTATIONS,  0),
    APT(SP_TROLL,           SK_FIRE_MAGIC,      0),
    APT(SP_TROLL,           SK_ICE_MAGIC,       0),
    APT(SP_TROLL,           SK_AIR_MAGIC,       0),
