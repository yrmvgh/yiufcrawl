...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    // SP_NIL
    APT(SP_NIL,           SK_FIGHTING,        0),
    APT(SP_NIL,           SK_SHORT_BLADES,    0),
    APT(SP_NIL,           SK_LONG_BLADES,     0),
    APT(SP_NIL,           SK_AXES,            0),
    APT(SP_NIL,           SK_MACES_FLAILS,    0),
    APT(SP_NIL,           SK_POLEARMS,        0),
    APT(SP_NIL,           SK_STAVES,          0),
    APT(SP_NIL,           SK_SLINGS,          0),
    APT(SP_NIL,           SK_BOWS,            0),
    APT(SP_NIL,           SK_CROSSBOWS,       0),
    APT(SP_NIL,           SK_THROWING,        0),
    APT(SP_NIL,           SK_ARMOUR,          0),
    APT(SP_NIL,           SK_DODGING,         0),
    APT(SP_NIL,           SK_STEALTH,         0),
#if TAG_MAJOR_VERSION == 34
    APT(SP_NIL,           SK_STABBING,      UNUSABLE_SKILL),
#endif
    APT(SP_NIL,           SK_SHIELDS,         0),
#if TAG_MAJOR_VERSION == 34
    APT(SP_NIL,           SK_TRAPS,         UNUSABLE_SKILL),
#endif
    APT(SP_NIL,           SK_UNARMED_COMBAT,  0),
    APT(SP_NIL,           SK_SPELLCASTING,    0),
    APT(SP_NIL,           SK_CONJURATIONS,    0),
    APT(SP_NIL,           SK_HEXES,           0),
    APT(SP_NIL,           SK_CHARMS,          0),
    APT(SP_NIL,           SK_SUMMONINGS,      0),
    APT(SP_NIL,           SK_NECROMANCY,      0),
    APT(SP_NIL,           SK_TRANSLOCATIONS,  0),
    APT(SP_NIL,           SK_TRANSMUTATIONS,  0),
    APT(SP_NIL,           SK_FIRE_MAGIC,      0),
    APT(SP_NIL,           SK_ICE_MAGIC,       0),
    APT(SP_NIL,           SK_AIR_MAGIC,       0),
    APT(SP_NIL,           SK_EARTH_MAGIC,     0),
    APT(SP_NIL,           SK_POISON_MAGIC,    0),
    APT(SP_NIL,           SK_INVOCATIONS,     0),
    APT(SP_NIL,           SK_EVOCATIONS,      0),
};
