...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_DORF,   SK_AXES,            1),
    APT(SP_DORF,   SK_MACES_FLAILS,    2),
    APT(SP_DORF,   SK_POLEARMS,       -1),
    APT(SP_DORF,   SK_STAVES,          1),
    APT(SP_DORF,   SK_SLINGS,         -1),
    APT(SP_DORF,   SK_BOWS,           -1),
    ...
    APT(SP_IMP,                 SK_BOWS,           -1),
    APT(SP_IMP,                 SK_CROSSBOWS,      -1),
    ...
    APT(SP_SKELETON,           SK_ICE_MAGIC,       0),
    APT(SP_SKELETON,           SK_AIR_MAGIC,       0),
    ...
    APT(SP_BEARKIN,         SK_EVOCATIONS,      2),
};
