...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_SLUDGE_ELF,      SK_POLEARMS,        0),
    ...
    APT(SP_SLUDGE_ELF,      SK_TRANSMUTATIONS,  1),
    ...
    APT(SP_HILL_ORC,        SK_TRANSMUTATIONS, -2),
    APT(SP_HILL_ORC,        SK_FIRE_MAGIC,      0),
    APT(SP_HILL_ORC,        SK_ICE_MAGIC,      -2),
    APT(SP_HILL_ORC,        SK_AIR_MAGIC,       0),
    APT(SP_HILL_ORC,        SK_EARTH_MAGIC,     0),
    APT(SP_HILL_ORC,        SK_POISON_MAGIC,   -2),
    ...
    // SP_DORF
    APT(SP_DORF,   SK_FIGHTING,        1),
    APT(SP_DORF,   SK_SHORT_BLADES,   -1),
    APT(SP_DORF,   SK_LONG_BLADES,     0),
    APT(SP_DORF,   SK_AXES,            0),
    APT(SP_DORF,   SK_MACES_FLAILS,    1),
    APT(SP_DORF,   SK_POLEARMS,       -1),
    APT(SP_DORF,   SK_STAVES,          1),
    APT(SP_DORF,   SK_SLINGS,         -1),
    APT(SP_DORF,   SK_BOWS,           -2),
    APT(SP_DORF,   SK_CROSSBOWS,       2),
    APT(SP_DORF,   SK_THROWING,        1),
    APT(SP_DORF,   SK_ARMOUR,          1),
    APT(SP_DORF,   SK_DODGING,        -1),
    APT(SP_DORF,   SK_STEALTH,        -3),
#if TAG_MAJOR_VERSION == 34
    APT(SP_DORF,   SK_STABBING,      UNUSABLE_SKILL),
#endif
    APT(SP_DORF,   SK_SHIELDS,         1),
#if TAG_MAJOR_VERSION == 34
    APT(SP_DORF,   SK_TRAPS,         UNUSABLE_SKILL),
#endif
    APT(SP_DORF,   SK_UNARMED_COMBAT,  0),
    APT(SP_DORF,   SK_SPELLCASTING,   -2),
    APT(SP_DORF,   SK_CONJURATIONS,   -1),
    APT(SP_DORF,   SK_HEXES,          -2),
    APT(SP_DORF,   SK_CHARMS,          0),
    APT(SP_DORF,   SK_SUMMONINGS,     -2),
    APT(SP_DORF,   SK_NECROMANCY,     -3),
    APT(SP_DORF,   SK_TRANSLOCATIONS,  0),
    APT(SP_DORF,   SK_TRANSMUTATIONS, -1),
    APT(SP_DORF,   SK_FIRE_MAGIC,      1),
    APT(SP_DORF,   SK_ICE_MAGIC,       0),
    APT(SP_DORF,   SK_AIR_MAGIC,      -2),
    APT(SP_DORF,   SK_EARTH_MAGIC,     2),
    APT(SP_DORF,   SK_POISON_MAGIC,   -1),
    APT(SP_DORF,   SK_INVOCATIONS,     0),
    APT(SP_DORF,   SK_EVOCATIONS,      3),
    ...
    APT(SP_DEEP_DWARF,      SK_ICE_MAGIC,       0),
    ...
    // SP_NULL
    APT(SP_NULL,           SK_FIGHTING,        0),
    APT(SP_NULL,           SK_SHORT_BLADES,    0),
    APT(SP_NULL,           SK_LONG_BLADES,     0),
    APT(SP_NULL,           SK_AXES,            0),
    APT(SP_NULL,           SK_MACES_FLAILS,    0),
    APT(SP_NULL,           SK_POLEARMS,        0),
    APT(SP_NULL,           SK_STAVES,          0),
    APT(SP_NULL,           SK_SLINGS,          0),
    APT(SP_NULL,           SK_BOWS,            0),
    APT(SP_NULL,           SK_CROSSBOWS,       0),
    APT(SP_NULL,           SK_THROWING,        0),
    APT(SP_NULL,           SK_ARMOUR,          0),
    APT(SP_NULL,           SK_DODGING,         0),
    APT(SP_NULL,           SK_STEALTH,         0),
#if TAG_MAJOR_VERSION == 34
    APT(SP_NULL,           SK_STABBING,      UNUSABLE_SKILL),
#endif
    APT(SP_NULL,           SK_SHIELDS,         0),
#if TAG_MAJOR_VERSION == 34
    APT(SP_NULL,           SK_TRAPS,         UNUSABLE_SKILL),
#endif
    APT(SP_NULL,           SK_UNARMED_COMBAT,  0),
    APT(SP_NULL,           SK_SPELLCASTING,    0),
    APT(SP_NULL,           SK_CONJURATIONS,    0),
    APT(SP_NULL,           SK_HEXES,           0),
    APT(SP_NULL,           SK_CHARMS,          0),
    APT(SP_NULL,           SK_SUMMONINGS,      0),
    APT(SP_NULL,           SK_NECROMANCY,      0),
    APT(SP_NULL,           SK_TRANSLOCATIONS,  0),
    APT(SP_NULL,           SK_TRANSMUTATIONS,  0),
    APT(SP_NULL,           SK_FIRE_MAGIC,      0),
    APT(SP_NULL,           SK_ICE_MAGIC,       0),
    APT(SP_NULL,           SK_AIR_MAGIC,       0),
    APT(SP_NULL,           SK_EARTH_MAGIC,     0),
    APT(SP_NULL,           SK_POISON_MAGIC,    0),
    APT(SP_NULL,           SK_INVOCATIONS,     0),
    APT(SP_NULL,           SK_EVOCATIONS,      0),
    ...
    // SP_OLD_OGRE
    APT(SP_OLD_OGRE,         SK_FIGHTING,        3),
    APT(SP_OLD_OGRE,         SK_SHORT_BLADES,   -5),
    APT(SP_OLD_OGRE,         SK_LONG_BLADES,    -5),
    APT(SP_OLD_OGRE,         SK_AXES,           -5),
    APT(SP_OLD_OGRE,         SK_MACES_FLAILS,    5),
    APT(SP_OLD_OGRE,         SK_POLEARMS,        0),
    APT(SP_OLD_OGRE,         SK_STAVES,         -5),
    APT(SP_OLD_OGRE,         SK_SLINGS,         -5),
    APT(SP_OLD_OGRE,         SK_BOWS,           -5),
    APT(SP_OLD_OGRE,         SK_CROSSBOWS,      -5),
    APT(SP_OLD_OGRE,         SK_THROWING,        0),
    APT(SP_OLD_OGRE,         SK_ARMOUR,         -2),
    APT(SP_OLD_OGRE,         SK_DODGING,        -1),
    APT(SP_OLD_OGRE,         SK_STEALTH,        -2),
#if TAG_MAJOR_VERSION == 34
    APT(SP_OLD_OGRE,         SK_STABBING,      UNUSABLE_SKILL),
#endif
    APT(SP_OLD_OGRE,         SK_SHIELDS,        -1),
#if TAG_MAJOR_VERSION == 34
    APT(SP_OLD_OGRE,         SK_TRAPS,         UNUSABLE_SKILL),
#endif
    APT(SP_OLD_OGRE,         SK_UNARMED_COMBAT, -5),
    APT(SP_OLD_OGRE,         SK_SPELLCASTING,    5),
    APT(SP_OLD_OGRE,         SK_CONJURATIONS,   -5),
    APT(SP_OLD_OGRE,         SK_HEXES,          -5),
    APT(SP_OLD_OGRE,         SK_CHARMS,         -5),
    APT(SP_OLD_OGRE,         SK_SUMMONINGS,     -5),
    APT(SP_OLD_OGRE,         SK_NECROMANCY,     -5),
    APT(SP_OLD_OGRE,         SK_TRANSLOCATIONS, -5),
    APT(SP_OLD_OGRE,         SK_TRANSMUTATIONS, -5),
    APT(SP_OLD_OGRE,         SK_FIRE_MAGIC,     -5),
    APT(SP_OLD_OGRE,         SK_ICE_MAGIC,      -5),
    APT(SP_OLD_OGRE,         SK_AIR_MAGIC,      -5),
    APT(SP_OLD_OGRE,         SK_EARTH_MAGIC,    -5),
    APT(SP_OLD_OGRE,         SK_POISON_MAGIC,   -5),
    APT(SP_OLD_OGRE,         SK_INVOCATIONS,     1),
    APT(SP_OLD_OGRE,         SK_EVOCATIONS,     -2),
};
