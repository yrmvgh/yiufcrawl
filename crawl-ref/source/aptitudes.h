...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    // SP_SURFACE_DWARF
    APT(SP_SURFACE_DWARF,   SK_FIGHTING,        1),
    APT(SP_SURFACE_DWARF,   SK_SHORT_BLADES,   -1),
    APT(SP_SURFACE_DWARF,   SK_LONG_BLADES,     0),
    APT(SP_SURFACE_DWARF,   SK_AXES,            0),
    APT(SP_SURFACE_DWARF,   SK_MACES_FLAILS,    1),
    APT(SP_SURFACE_DWARF,   SK_POLEARMS,       -1),
    APT(SP_SURFACE_DWARF,   SK_STAVES,          1),
    APT(SP_SURFACE_DWARF,   SK_SLINGS,         -1),
    APT(SP_SURFACE_DWARF,   SK_BOWS,           -2),
    APT(SP_SURFACE_DWARF,   SK_CROSSBOWS,       2),
    APT(SP_SURFACE_DWARF,   SK_THROWING,        1),
    APT(SP_SURFACE_DWARF,   SK_ARMOUR,          1),
    APT(SP_SURFACE_DWARF,   SK_DODGING,        -1),
    APT(SP_SURFACE_DWARF,   SK_STEALTH,        -3),
#if TAG_MAJOR_VERSION == 34
    APT(SP_SURFACE_DWARF,   SK_STABBING,      UNUSABLE_SKILL),
#endif
    APT(SP_SURFACE_DWARF,   SK_SHIELDS,         1),
#if TAG_MAJOR_VERSION == 34
    APT(SP_SURFACE_DWARF,   SK_TRAPS,         UNUSABLE_SKILL),
#endif
    APT(SP_SURFACE_DWARF,   SK_UNARMED_COMBAT,  0),
    APT(SP_SURFACE_DWARF,   SK_SPELLCASTING,   -2),
    APT(SP_SURFACE_DWARF,   SK_CONJURATIONS,   -1),
    APT(SP_SURFACE_DWARF,   SK_HEXES,          -2),
    APT(SP_SURFACE_DWARF,   SK_CHARMS,          0),
    APT(SP_SURFACE_DWARF,   SK_SUMMONINGS,     -2),
    APT(SP_SURFACE_DWARF,   SK_NECROMANCY,     -3),
    APT(SP_SURFACE_DWARF,   SK_TRANSLOCATIONS,  0),
    APT(SP_SURFACE_DWARF,   SK_TRANSMUTATIONS, -1),
    APT(SP_SURFACE_DWARF,   SK_FIRE_MAGIC,      1),
    APT(SP_SURFACE_DWARF,   SK_ICE_MAGIC,       0),
    APT(SP_SURFACE_DWARF,   SK_AIR_MAGIC,      -2),
    APT(SP_SURFACE_DWARF,   SK_EARTH_MAGIC,     2),
    APT(SP_SURFACE_DWARF,   SK_POISON_MAGIC,   -1),
    APT(SP_SURFACE_DWARF,   SK_INVOCATIONS,     0),
    APT(SP_SURFACE_DWARF,   SK_EVOCATIONS,      3),
