...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_TROLL,           SK_SUMMONINGS,     -1),
    APT(SP_TROLL,           SK_NECROMANCY,      0),
    APT(SP_TROLL,           SK_TRANSLOCATIONS, -1),
    APT(SP_TROLL,           SK_TRANSMUTATIONS, -1),
    APT(SP_TROLL,           SK_FIRE_MAGIC,     -1),
    APT(SP_TROLL,           SK_ICE_MAGIC,      -1),
    APT(SP_TROLL,           SK_AIR_MAGIC,      -2),
    APT(SP_TROLL,           SK_EARTH_MAGIC,     1),
    APT(SP_TROLL,           SK_POISON_MAGIC,   -1),
    ...
    APT(SP_DJINNI,          SK_SPELLCASTING,    9),
    APT(SP_DJINNI,          SK_CONJURATIONS,    0),
    APT(SP_DJINNI,          SK_HEXES,           1),
    APT(SP_DJINNI,          SK_CHARMS,         -1),
    APT(SP_DJINNI,          SK_SUMMONINGS,     -1),
    APT(SP_DJINNI,          SK_NECROMANCY,     -3),
    APT(SP_DJINNI,          SK_TRANSLOCATIONS, -1),
    APT(SP_DJINNI,          SK_TRANSMUTATIONS, -1),
    APT(SP_DJINNI,          SK_FIRE_MAGIC,      4),
    APT(SP_DJINNI,          SK_ICE_MAGIC,      -4),
    APT(SP_DJINNI,          SK_AIR_MAGIC,       1),
    APT(SP_DJINNI,          SK_EARTH_MAGIC,    -4),
