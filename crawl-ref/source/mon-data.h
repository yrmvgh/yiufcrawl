...
// Helpal's familiar - variable traits
{
    MONS_FAMILIAR, 'R', LIGHTCYAN, "familiar",
    M_FAMILIAR | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_FLIES,
    MR_NO_FLAGS,
    1, MONS_FAMILIAR, MONS_FAMILIAR, MH_DEMONIC, -5,
    { {AT_HIT, AF_PLAIN, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 1,
    5, 10, MST_NO_SPELLS, CE_NOCORPSE, S_DEMON_TAUNT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LITTLE, MON_SHAPE_HUMANOID_WINGED_TAILED
},

{
    MONS_FAMILIAR_BUER, 'R', LIGHTCYAN, "buer",
    M_FAMILIAR | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_FLIES,
    MR_NO_FLAGS,
    1, MONS_FAMILIAR, MONS_FAMILIAR_BUER, MH_DEMONIC, -5,
    { {AT_HIT, AF_PLAIN, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 1,
    5, 10, MST_NO_SPELLS, CE_NOCORPSE, S_DEMON_TAUNT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...
{
    MONS_FAMILIAR_HAGENTI, 'R', LIGHTCYAN, "hagenti",
    M_FAMILIAR | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_FLIES,
    MR_NO_FLAGS,
    1, MONS_FAMILIAR, MONS_FAMILIAR_HAGENTI, MH_DEMONIC, -5,
    { {AT_HIT, AF_PLAIN, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 1,
    5, 10, MST_NO_SPELLS, CE_NOCORPSE, S_DEMON_TAUNT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...
{
    MONS_FAMILIAR_SABNOK, 'R', LIGHTCYAN, "sabnok",
    M_FAMILIAR | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_FLIES,
    MR_NO_FLAGS,
    1, MONS_FAMILIAR, MONS_FAMILIAR_SABNOK, MH_DEMONIC, -5,
    { {AT_HIT, AF_PLAIN, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 1,
    5, 10, MST_NO_SPELLS, CE_NOCORPSE, S_DEMON_TAUNT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
