...

{
    ...
    { {AT_CLAW, AF_PAIN, 36}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    20, 1080,
    8, 18, MST_NO_SPELLS, CE_NOCORPSE, S_SCREECH,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_FIGHTER | M_SEE_INVIS,
    MR_NO_FLAGS,
    9, MONS_GIANT, MONS_STONE_GIANT, MH_NATURAL, 100,
    { {AT_HIT, AF_PLAIN, 70}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    16, 2400,
    10, 1, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, SIZE_GIANT, MON_SHAPE_HUMANOID,
...

{
    ...
    M_SEE_INVIS | M_WARM_BLOOD,
    mrd(MR_RES_FIRE, 2) | mrd(MR_RES_COLD, 2),
    12, MONS_DRAGON, MONS_THE_GIAGGOSTUONO, MH_NATURAL, 180,
...

{
    ...
    MR_NO_FLAGS,
    20, MONS_ORB_GUARDIAN, MONS_DEV_FAVORITE, MH_NATURAL, 120,
    { {AT_HIT, AF_HOLY, 45}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 825,
    13, 13, MST_WRETCHED_STAR, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 14, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_GIANT, MON_SHAPE_MISC,
...

{
    ...
    M_NO_FLAGS,
    mrd(MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC, 3),
    10, MONS_GOLEM, MONS_ZOTLING, MH_NONLIVING, MAG_IMMUNE,
    { {AT_HIT, AF_PLAIN, 31}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 540,
    20, 5, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 18, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_SMALL, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    16, 1010,
    15, 12, MST_CRYSTAL_GUARDIAN, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 13, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
