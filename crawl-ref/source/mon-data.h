...
{
    MONS_ANCESTOR_FIGHTER, 'W', YELLOW, "knight",
    M_ANCESTOR | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_FLIES,
    MR_NO_FLAGS,
    1, MONS_ANCESTOR, MONS_ANCESTOR_FIGHTER, MH_UNDEAD, -5,
    { {AT_HIT, AF_PLAIN, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 1,
    5, 10, MST_NO_SPELLS, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...
{
    MONS_ANCESTOR_WIZARD, 'W', YELLOW, "battlemage",
    M_ANCESTOR | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_FLIES,
    MR_NO_FLAGS,
    1, MONS_ANCESTOR, MONS_ANCESTOR_WIZARD, MH_UNDEAD, -5,
    { {AT_HIT, AF_PLAIN, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 1,
    5, 10, MST_NO_SPELLS, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...
{
    MONS_ANCESTOR_ENCHANTER, 'W', YELLOW, "hexer",
    M_ANCESTOR | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_FLIES,
    MR_NO_FLAGS,
    1, MONS_ANCESTOR, MONS_ANCESTOR_ENCHANTER, MH_UNDEAD, -5,
    { {AT_HIT, AF_PLAIN, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 1,
    5, 10, MST_NO_SPELLS, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
