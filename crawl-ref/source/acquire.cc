                                     ...
                                     int agent = -1)
{
    ...
    while (1)
    {
        ...
        case OBJ_RODS:
            ...
            while (type_wanted == ROD_DESTRUCTION_I
                   || type_wanted == ROD_DESTRUCTION_II
                   || type_wanted == ROD_DESTRUCTION_III
                   || type_wanted == ROD_WARDING
                   || type_wanted == ROD_DEMONOLOGY
                   || type_wanted == ROD_VENOM);
#endif
            break;
